const nameGirl = 'Thanh Hiền';
const giftUrl = '';
const eventName = 'Chúc Mừng 8/3';
const titleCard = 'friend';
const contentCard = "Ngày 8/3 đã đến rồi, chúc một nửa xinh đẹp của thế giới luôn thành công và hạnh phúc trong cuộc sống";
